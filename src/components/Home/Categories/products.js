...
export const productListOne = {
    productOne: {
        img: C1P1,
        storeName: ' 1 موديفا ستور',
        productName: ' 1 جاكيت بامبي نسائي',
        price: '17.00 ر.س',
        oldPrice: '21.00 ر.س',
    },
    productTwo: {
        ...
        productName: ' 2 جاكيت بامبي رجالي',
        price: '18.00 ر.س',
        oldPrice: '20.00 ر.س',
    },
    productThree: {
    ...
    productFour: {
        ...
        productName: ' 4 جاكيت بامبي نسائي',
        price: '17.00 ر.س',
        oldPrice: '21.00 ر.س',
    },
    productFive: {
        img: C1P2,
        storeName: 'فاكتور ستور',
        productName: ' 5 جاكيت بامبي رجالي',
        price: '18.00 ر.س',
        oldPrice: '20.00 ر.س',
    },
    productSix: {
